...
const faqRecruitData = [
    {
        ...
        answer: 'TAVE는 개발 경험보다 적극적인 태도, 열정, 책임감을 가장 중요하게 생각합니다.',
    },
    {
        question: '여러 직군에 중복하여 지원하는 것이 가능한가요?',
        answer: '중복 지원은 불가능합니다. 중복 지원자의 경우 먼저 제출한 지원서를 기준으로 처리합니다.',
    },
    {
    ...
    },
    {
        ...
        answer: '면접은 오프라인 3 대 3 면접으로 25분간 동아리 임원진과 이야기를 나누는 형식으로 진행됩니다. 불가피한 사유로 인한 대면 면접이 힘드실 경우, TAVE 공식 카카오 채널 혹은 인스타 DM으로 문의 바랍니다.',
    },
    {
        question: '해당 분야에 기초적인 베이스 지식이 있어야만 지원할 수 있을까요?',
        answer: '스터디를 원활하게 진행하기 위해 최소한의 기본 지식을 갖춘 상태에서 지원하는 것을 권장합니다. 팀 빌딩은 수준에 맞는 팀원을 만나 구성할 수 있지만, 활동을 따라가기 위한 기본적인 이해도는 필요합니다.',
    },
    {
        question: '면접 장소의 위치를 미리 알 수 있나요?',
        answer: '면접 장소는 현재 서울 소재로 정해졌으며, 구체적인 장소는 서류 합격 후 추후 안내될 예정입니다. 지원자분들의 형평성을 위해 정확한 위치는 말씀드릴 수 없는 점 양해 부탁드립니다.',
    },
];
...
const faqActivityData = [
    ...
    {
        question: '동아리의 정기 행사는 언제 진행되나요?',
        answer: '모든 정기행사 및 스터디/프로젝트 일정은 토요일에 진행됩니다. 정기 행사 시간은 2~6시 사이로 고정이고, 스터디/프로젝트 시간은 팀원들과 조율하에 자유롭게 설정하실 수 있습니다.',
    },
    {
        question: '토요일 정규 세션에 대외 활동 등의 사유로 불참이 허용되나요?',
        answer: '토요일 정규 세션은 원칙적으로 필참이며, 스터디/프로젝트 기간에 약 1~2주 정도의 휴동이 허용됩니다. 인정 불참 사유(기사 시험, 경조사, 회사 면접 등)가 아닌 경우 활동 점수가 크게 감점되며, 일정 점수 미만이 되면 자동으로 탈퇴 처리 됩니다.',
    },
];
