...
const Submit = () => {
    ...
    return (
        <>
            ...
            {selectedTab === 'field' && (
                <>
                    <Disclosure title={programmingTitle}>
                    ...
                    {fieldAnswer
                        .filter((item) => item.answerType === 'TEXTAREA')
                        .map((item, index) => (
            ...
            {selectedTab === 'common' && (
                <>
                    ...
                    <Disclosure title={uploadTitle}>
                        <FlexBox className="gap-6 text-sm md:text-base text-[#394150]/60 font-medium">
                            {links.github && (
                                <Link
                                    href={links.github}
