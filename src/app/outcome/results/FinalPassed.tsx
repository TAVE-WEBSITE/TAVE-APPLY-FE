    ...
    return (
        <div className="text-[#394150] text-center">
            <FlexBox direction="col" className="md:gap-28 gap-23">
                <div>
                    <p className="text-2xl md:text-[27px] font-bold mb-3">
                        TAVE {generation}기 회원이 되신 것을 <br className="md:hidden" />
                        진심으로 축하드립니다!
                    </p>
                    <p className="font-medium text-[13px] md:text-base md:leading-normal leading-[22px]">
                        <br />
                        안녕하세요, IT 연합 동아리 TAVE {generation}기 운영진 입니다.
                        <br />
                        {username}님께서 TAVE {generation}기 회원 모집에
                        <span className="text-[#195bff] font-extrabold"> 최종 합격</span>
                        하셨습니다. <br />
                        <br />
                ...
                <FlexBox direction="col" className="gap-5 font-medium text-sm md:text-base leading-normal">
                    <div className="font-bold">
                        ...
                        <p className="md:text-[27px] text-2xl">회비 입금</p>
                    </div>
                    <div>
                        <p>
                            {generation}기 회비는 총
                ...
                <FlexBox direction="col" className="gap-5">
                    <div className="font-bold">
                        ...
                        <p className="md:text-[27px] text-2xl">아지트 초대 설문 조사</p>
                    </div>
                ...
                <FlexBox direction="col" className="gap-5">
                    <div className="font-bold">
                        ...
                        <p className="md:text-[27px] text-2xl">{firstSession.title} 공지방 입장</p>
                    </div>
                    <p className="font-medium text-sm md:text-base md:mb-4">
