        ...
        <>
            ...
            <FlexBox className="pt-4 gap-8" direction="col">
                ...
                <div className="flex flex-col-reverse md:flex-row font-bold md:justify-between py-8 gap-1">
                    ...
                    <ButtonNavigate text="가입" isActive={checkAll} onClick={handleSignUp} />
                </div>
                <ToastMessage isOpen={isToastOpen} isError={true} setIsOpen={setIsToastOpen} message={toastmessage} />
            </FlexBox>
        </>
    );
};
