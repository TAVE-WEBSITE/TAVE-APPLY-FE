...
const ResetPassword = () => {
    ...
    const passwordConfirmError = useValidation(newPassword, validatePasswordConfirm, passwordConfirm);
    ...
    return (
        <FlexBox className="pt-4 gap-8" direction="col">
            ...
            <ToastMessage isError={isError} message={toastMessage} isOpen={isToastOpen} setIsOpen={setIsToastOpen} />
