...
const Field = () => {
    ...
    return (
        <FlexBox direction="col" className="gap-10">
            <h1 className="font-bold text-2xl text-[#394150] text-center">웹 프론트엔드 분야</h1>
            ...
            <Disclosure title={'기타 활용 가능한 기술 스택이 있으신가요?'}>
                <InputField value={techStack} setValue={setTechStack} placeholder="스택을 입력해주세요" />
            </Disclosure>
            <Disclosure
                title={
            ...
            <Disclosure
                title={'다른 분야와의 연합 프로젝트 경험 및 협업 경험에 대해 자세하게 서술해주세요. (700자 이내)'}
                isRequired={true}
            >
                <TextArea
                    value={question2}
